...
import { shorten, trim, prettifySecondsForEther } from "../../helpers";
...
function BondPurchase({ bond, slippage }: IBondPurchaseProps) {
    ...
    const vestingPeriod = () => {
        return prettifySecondsForEther(bond.vestingTerm, "day");
    };
            ...
            <Slide direction="left" in={true} mountOnEnter unmountOnExit {...{ timeout: 533 }}>
                <Box className="bond-data">
                    ...
                    <div className="data-row">
                        ...
                        <p className="price-data bond-balance-title">{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.bondQuote, 4)} STRIP`}</p>
                    </div>

                    <div className={`data-row`}>
                        <p className="bond-balance-title">Max You Can Buy</p>
                        <p className="price-data bond-balance-title">{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} STRIP`}</p>
                    </div>
                    ...
                    <div className="data-row">
                        ...
                        <p className="bond-balance-title">0.01 STRIP</p>
                    </div>
                </Box>
            </Slide>
